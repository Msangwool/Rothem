...
import org.haram.rothem.data.dto.admin.request.CalendarAvailableRequest;
...
public class CalendarMasterService {
    ...
    public Calendar save(Calendar calendar) {
        return calendarDao.save(calendar)
                .orElseThrow(() -> new HaramEntityExistException("이미 존재하는 Calendar 입니다.", RothemErrorCode.ALREADY_EXIST_CALENDAR));
    }
